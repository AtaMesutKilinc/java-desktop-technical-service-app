...
public class ArchiveImpl implements IArchive {
    DB db =new DB();
    List<Service> archiveList=new ArrayList<>();
    List<Service> archiveListCopy=new ArrayList<>();

    //List<Service> serviceList=new ArrayList<>();

    public ArchiveImpl() {
        archiveList=serviceArchiveList();
        archiveListCopy=archiveList;
    }

    @Override
    public DefaultTableModel serviceArchiveTable(String data) {
        archiveList=archiveListCopy;
    ...
    @Override
    public List<Service> serviceArchiveList() {
        List<Service> serviceList=new ArrayList<>();
        ...
        try
        {
            ...
            serviceList.clear(); //buna dikkat et
            while(rs.next())
            {
